...
<div id="wrapper">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <pre class="joe"><center><h4><label>Gold:<u>0</u></label>    <label>Knowledge:<u>0</u></label>    <label>Timer: 0:31</label></h4></center></pre>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="container">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <p align="right"><input type="button" class="btn btn-warning" value="Next question"></p>
            </li>
        </ul>
    </div>
    <!-- /#page-wrapper -->
