...
<div id="wrapper">
	...
	public 2. <input type="text"> 3.<input type="text"> 4.<input type="text">(String [] args){
		5.<input type="text">.print("Hello class");
                    ...
                    <p id="test"align="right" valign="bottom"><a href="/lastQuestion"><input type="button" id="Next" class="btn btn-primary" value="Next"></a></p>
                </div>
            </div>
        </div>
        <!-- /.row -->
    ...
    <div class="container">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <p align="right"><input type="button" class="btn btn-warning" value="Ship"></p>
            </li>
        </ul>
    </div>
    <!-- /#page-wrapper -->
