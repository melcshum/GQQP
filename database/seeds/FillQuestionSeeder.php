...
class FillQuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $fillquestions = array(['question_id'=>1, 'teacher_id'=>1, 'question_type'=>'class','type'=>"fill",'question_level'=>3,'question'=>'Create Hello class and have a main class to print "Hello class":'
            ,'program'=>'<pre>public class 1.<input type="text" id="ans1">{
	public 2. <input type="text" id="ans2"> 3.<input type="text" id="ans3"> 4.<input type="text" id="ans4">(String [] args){
		5.<input type="text" id="ans5">.print("Hello class");
	}
}
</pre>'
